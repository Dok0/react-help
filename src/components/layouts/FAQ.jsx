                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="flat-accordion" data-aos="fade-up">
                            {
                                data.map((data,index) => (
                                    <Accordion className="h5 toggle-title" key={'faq-data'+index} title={data.title} show={data.show}>
                    ...
                    <div className="col-md-6">
                        <div className="flat-accordion" data-aos="fade-up">
                            {
                                data.map((data,index) => (
                                    <Accordion className="h5 toggle-title" key={'faq-data-2'+index} title={data.title} >
                                            <p className="fs-18">{data.text}</p>
                                        </Accordion>
                                ))
                            }                      
